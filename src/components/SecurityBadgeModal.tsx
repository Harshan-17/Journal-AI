...
export const SecurityBadgeModal: React.FC<SecurityBadgeModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-stone-950/80 backdrop-blur-md animate-in fade-in duration-150">
      <div className="bg-stone-900/95 border border-stone-800 rounded-3xl w-full max-w-2xl max-h-[90vh] flex flex-col shadow-2xl overflow-hidden text-stone-100 backdrop-blur-xl">
        {/* Header */}
        <div className="p-5 border-b border-stone-800/80 flex items-center justify-between bg-stone-950/80">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-base font-semibold text-stone-100">Security Architecture & Isolation</h3>
              <p className="text-xs text-stone-400">Enterprise Security Invariants & Isolation</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-xs text-stone-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div className="p-4 rounded-2xl bg-stone-950/70 border border-stone-800/80 space-y-1.5 shadow-sm">
          ...
          <div className="space-y-2">
            ...
            <pre className="p-4 bg-stone-950 border border-stone-800 rounded-2xl font-mono text-[11px] text-stone-300 overflow-x-auto leading-relaxed">
{`rules_version = '2';
      ...
      match /interactions/{interactionId} {
        allow read, write: if request.auth != null && request.auth.uid == userId;
          ...
          <div className="space-y-2">
            ...
            <div className="p-3.5 bg-stone-950 border border-stone-800 rounded-2xl space-y-2 font-mono text-[11px] text-stone-400">
              <div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-stone-800/80 flex justify-end bg-stone-950/80">
          <button
            onClick={onClose}
            className="px-4 py-2 bg-stone-800 hover:bg-stone-700 text-stone-200 font-semibold text-xs rounded-xl transition-colors cursor-pointer"
          >
